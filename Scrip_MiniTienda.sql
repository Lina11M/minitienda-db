...
-- Insertar__________________________
DELIMITER //
CREATE PROCEDURE proInsertUsers(IN v_correo VARCHAR(90), IN v_contrasena TEXT, IN v_salt TEXT, IN v_estado VARCHAR(25))
BEGIN
...
-- Actualizar_____________________
DELIMITER //
CREATE PROCEDURE proUpdateUsers(IN v_id INT, IN v_correo VARCHAR(90), IN v_contrasena TEXT, IN v_salt TEXT, IN v_estado VARCHAR(25))
BEGIN 
    UPDATE tbl_usuarios
